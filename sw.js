...
const SHELL = [
  ...
  './js/onboarding.js', './js/sync.js', './js/tour.js', './js/brief.js', './js/knowhow.js', './js/delivery.js', './js/production.js', './js/migrations.js', './js/businessdays.js', './js/clock.js', './js/inbox.js',
  './js/pages/inbox.js', './js/pages/quick.js', './js/pages/home.js', './js/pages/guide.js'
];
