...
export const HELP = {
  ...
  'time.samples': 'המערכת שואלת "מה אתה עושה עכשיו?" בזמנים אקראיים, ואתה לוחץ כפתור אחד. כל דגימה מייצגת פרק זמן קבוע, אז ספירת הדגימות היא המדידה. 12 ביום על חלון של 10 שעות = כל דגימה שווה 50 דקות. זה מדויק יותר מטיימר, כי טיימר שוכחים להחליף ודגימה שואלת אותך בעצמה.',
  'time.sampleFreq': 'יותר דגימות = המספר מתייצב מהר יותר, אבל יותר הפרעות. 12 ביום זו הפרעה אחת ל-50 דקות, ואחרי שבוע כבר יש מספר אמין לסרטון.',
