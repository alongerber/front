...
const FAQ = [
  ...
  ['קלטתי בטלפון — איך זה מגיע למחשב?',
    'לא לבד. אין שרת ואין סנכרון אוטומטי, אז הנתונים של הטלפון והמחשב נפרדים. ' +
    'הדרך היום: בטלפון הגדרות → ייצוא גיבוי, לשלוח לעצמך, ובמחשב ייבוא → "צרף למה שיש". ' +
    'צירוף מאחד לפי מזהה ובהתנגשות מנצח מה שעודכן אחרון, אז שום צד לא נמחק. ' +
    'שים לב שצירוף לא מוחק — מה שמחקת בטלפון יחזור מהמחשב.'],
